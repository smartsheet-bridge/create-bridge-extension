...
An object that consists of metadata properties in the context of the triggering user and extension. This context will be unique to the platform the function is being executed for.
