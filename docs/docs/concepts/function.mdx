...
Promises will be executed and either fully resolved or rejected before eventually returning the response allowing you to write asynchronous extension functions as if they were synchronous.
